...
class FeatureFlagManager:
    ...
    async def is_enabled(self, key: str) -> bool:
        ...
        try:
            ...
            return enabled == 'true' if enabled else self._get_default_flag_value(key)
        except Exception as e:
    ...
    def _get_default_flag_value(self, key: str) -> bool:
        """Get default value for feature flags"""
        defaults = {
            'custom_agents': True,  # Enable custom agents by default
            'agent_workflows': True,  # Enable agent workflows by default
            'mcp_integrations': True,  # Enable MCP integrations by default
        }
